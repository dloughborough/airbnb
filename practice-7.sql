...
SELECT listings.property_type, COUNT(*), MAX(reviews.date_reviewed) FROM reviews INNER JOIN listings ON listings.id = reviews.listing_ID GROUP BY listings.property_type;
